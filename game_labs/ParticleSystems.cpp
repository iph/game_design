...
void ParticleSystems::CreateScene ()
{
	...
	Root root = Bone::build_man_from_file();
	...
	*/
	...
	cyl->SetEffectInstance(Texture2DEffect::CreateUniqueInstance(baseTexture, Shader::SF_LINEAR,Shader::SC_CLAMP_EDGE, Shader::SC_CLAMP_EDGE));
	mScene->AttachChild(cyl);
	cyl = sm.Cylinder(10, 10, 1.0f, 1.0f, false);
	cyl->LocalTransform.SetTranslate(APoint(7.0f, 0.0f, 0.0f));
	cyl->SetEffectInstance(Texture2DEffect::CreateUniqueInstance(baseTexture, Shader::SF_LINEAR,Shader::SC_CLAMP_EDGE, Shader::SC_CLAMP_EDGE));
	mScene->AttachChild(cyl);
}
//----------------------------------------------------------------------------
